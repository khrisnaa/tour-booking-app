<div
    class="fixed start-0 top-0 z-[80] hidden size-full items-center justify-center overflow-y-auto overflow-x-hidden"
    :class="{ 'flex': show, 'hidden': !show }"
    x-data="{ show: false }"
    x-on:open-modal.window = "show=true; $wire.set('categoryId', $event.detail.categoryId)"
    x-on:close-modal.window = "show=false"
>
    <div
        class="absolute left-0 top-0 z-0 h-full w-full bg-black opacity-50"
