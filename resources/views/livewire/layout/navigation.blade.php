...
<header x-data="{ open: false }"
    ...
    <nav class="mx-auto flex w-full basis-full items-center px-4 sm:px-6">
        <div class="me-5 lg:me-0 lg:hidden">
            <!-- Logo -->
            <a class="inline-block flex-none whitespace-nowrap rounded-md text-xl font-semibold focus:opacity-80 focus:outline-none"
        ...
        <div class="ms-auto flex w-full items-center justify-end gap-x-1 md:justify-end md:gap-x-3">
