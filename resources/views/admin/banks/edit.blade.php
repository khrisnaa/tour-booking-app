<x-app-layout back="{{ route('admin.banks.index') }}">
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            {{ __('Update Bank Account') }}
        </h2>
        <p class="text-sm text-gray-500">Edit a bank account to organize your products and improve the navigation of
            your
            store</p>
    </x-slot>
    ...
    <!-- Form Section -->
    <div>
        <form action="{{ route('admin.banks.update', $bank) }}"
            method="POST"
