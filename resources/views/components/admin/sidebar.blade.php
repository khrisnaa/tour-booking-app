<div class="hs-overlay fixed inset-y-0 start-0 z-[60] hidden h-full w-[260px] -translate-x-full transform border-e border-gray-200 bg-white transition-all duration-300 [--auto-close:lg] hs-overlay-open:translate-x-0 lg:bottom-0 lg:end-auto lg:block lg:translate-x-0"
            ...
            <nav class="hs-accordion-group flex w-full flex-col flex-wrap p-3"
                ...
                <ul class="flex flex-col space-y-1">
                    ...
                    <x-admin.nav-link href="{{ route('admin.tour-packages.index') }}"
                        ...
                        text="Tour Packages"
                        :active="request()->routeIs('admin.tour-packages*')" />
